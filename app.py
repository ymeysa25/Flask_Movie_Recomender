...
from RSEngine import  load_movie, get_recommendations, get_movie, searchMovie
import pickle
...
def searchPage():
    ...
    movie_search = searchMovie(search_field, limit=20)
    return render_template("search_page.html", search_field = search_field ,movie_search = movie_search)
